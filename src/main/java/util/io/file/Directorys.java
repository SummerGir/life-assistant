...
public class Directorys {
    ...
    public static Collection<Path> getFiles(Path dir, boolean recursive) throws IOException {
        return getFiles(dir, (Filter)null, recursive);
    }

    public static Collection<Path> getFiles(Path dir, Filter<? super Path> filter, boolean recursive) throws IOException {
    ...
    public static Collection<Path> getPaths(Path dir, boolean recursive) throws IOException {
        return getPaths(dir, (Filter)null, recursive);
    }

    public static Collection<Path> getPaths(Path dir, Filter<? super Path> filter, boolean recursive) throws IOException {
        return getPaths(dir, filter, false, recursive);
    }

    private static Collection<Path> getPaths(Path dir, final Filter<? super Path> filter, final boolean excludeDir, boolean recursive) throws IOException {
        final Filter<? super Path> filter2 = new Filter<Path>() {
